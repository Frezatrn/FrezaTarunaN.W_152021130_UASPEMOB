...
import 'package:uasapp/screens/dashboard/widgets/item_news_feed.dart';
import 'package:uasapp/screens/dashboard/widgets/item_service.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Mobile App', style: TextStyle(color: Colors.white),),
        centerTitle: true,
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Aplikasi serbaguna!', style: Theme.of(context).textTheme.titleLarge?.copyWith(
                  color: Colors.white,
                ),),
                const SizedBox(height: 5),
                const Text(
                  'Semoga aplikasi ini dapat sedikit membantu anda',
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: const [
                      ...
                      ItemService(title: 'Belajar\nMobil', image: 'assets/images/traffic.png'),
                      ItemService(title: 'Belajar\nBersama', image: 'assets/images/challan.png'),
                      ItemService(title: 'Belajar\nLisensi', image: 'assets/images/license.png'),
                      ItemService(title: 'Map\nJalan', image: 'assets/images/route.png'),
                    ],
                  ),
                ),
                const SizedBox(height: 15),
