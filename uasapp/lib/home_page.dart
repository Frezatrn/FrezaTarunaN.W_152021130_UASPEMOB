...
import 'package:uasapp/database_service.dart';
import 'package:uasapp/todo.dart';
...
class _HomePageState extends State<HomePage> {
              ...
              return Slidable(
                startActionPane: ActionPane(
                  ...
                  children: [
                    SlidableAction(
                      onPressed: (context) {
                        // Panggil fungsi untuk menghapus data dari Firestore
                        deleteTodo(todoId);
                      },
  ...
  void deleteTodo(String todoId) async {
    try {
      // Mendapatkan referensi ke dokumen yang ingin dihapus
      ...
      print('Error saat menghapus todo: $e');
    }
  }
